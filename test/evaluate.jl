...
@testset "how evaluate handles mixs" begin
    id = IndexedDistribution(MvNormal(ones(3)), ["a", "b", "c"])
    ...
    @testset "IteratorOfObs" begin
        ...
        evaluate(dummy_metric1, Normal(), id, 1, [1, 2, 3], [10 20 30; 10 20 30])
    end
    ...
    @testset "MatrixColsOfObs" begin
        ...
        evaluate(dummy_metric2, Normal(), id, 1, [1, 2, 3], [10 20 30; 10 20 30])
    end
    ...
    @testset "MatrixRowsOfObs" begin
        ...
        evaluate(dummy_metric3, Normal(), id, 1, [1, 2, 3], [10 20 30; 10 20 30])
    end
end
